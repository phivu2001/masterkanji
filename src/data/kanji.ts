...
const rawKanjiData: KanjiInfo[] = [
    ...
    { id: "ori", kanji: "降", hanviet: "Giáng", meaning: "Xuống xe; mưa/tuyết rơi", onyomi: "コウ (kou)", kunyomi: "お.りる (o.riru), ふ.る (fu.ru)", level: "N4", components: [{ kanji: "阝", meaning: "Phụ (Gò đất)" }, { kanji: "夂", meaning: "Trĩ (Bám theo)" }, { kanji: "牛", meaning: "Ngưu (Bò)" }], mnemonic: "XUỐNG XE đi theo (夂) con bò (牛) ở gò đất (阝); mưa từ trời RƠI XUỐNG.", vocabularies: [{ kanji: "降りる", reading: "おりる (oriru)", meaning: "Xuống xe" }, { kanji: "降る", reading: "ふる (furu)", meaning: "Rơi (Mưa, tuyết)" }] },
