      ...
      <div className="max-w-6xl mx-auto">
        ...
        {words.length > 0 && <section className="mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <button disabled={clozeCount < 4} onClick={() => onStartCloze(words, `Cloze Test ${libraryTitle}`)} className="text-left rounded-2xl border border-amber-100 dark:border-amber-900/40 bg-amber-50 dark:bg-amber-900/10 p-4 hover:border-amber-400 disabled:opacity-40 transition-colors"><span className="w-10 h-10 rounded-xl bg-amber-500 text-white flex items-center justify-center mb-3"><i className="fas fa-quote-right"></i></span><b className="block">Cloze thực tế</b><span className="text-xs text-slate-500 dark:text-slate-400">{clozeCount} câu đã biên soạn</span></button>
